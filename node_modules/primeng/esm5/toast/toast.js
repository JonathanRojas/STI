...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r934); var ctx_r933 = ɵngcc0.ɵɵnextContext(); return ctx_r933.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r934); var ctx_r935 = ɵngcc0.ɵɵnextContext(); return ctx_r935.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r931.message.severity == "info", ctx_r931.message.severity == "warn", ctx_r931.message.severity == "error", ctx_r931.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r931.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r931.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r941); var ctx_r940 = ɵngcc0.ɵɵnextContext(); return ctx_r940.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r941); var ctx_r942 = ɵngcc0.ɵɵnextContext(); return ctx_r942.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var msg_r938 = ctx.$implicit;
    var i_r939 = ctx.index;
    var ctx_r937 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r938)("index", i_r939)("template", ctx_r937.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r937.showTransformOptions)("hideTransformOptions", ctx_r937.hideTransformOptions)("showTransitionOptions", ctx_r937.showTransitionOptions)("hideTransitionOptions", ctx_r937.hideTransitionOptions);
} }
