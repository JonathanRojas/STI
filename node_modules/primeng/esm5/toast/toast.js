...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r825); var ctx_r824 = ɵngcc0.ɵɵnextContext(); return ctx_r824.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r825); var ctx_r826 = ɵngcc0.ɵɵnextContext(); return ctx_r826.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r822.message.severity == "info", ctx_r822.message.severity == "warn", ctx_r822.message.severity == "error", ctx_r822.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r822.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r822.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r832); var ctx_r831 = ɵngcc0.ɵɵnextContext(); return ctx_r831.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r832); var ctx_r833 = ɵngcc0.ɵɵnextContext(); return ctx_r833.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var msg_r829 = ctx.$implicit;
    var i_r830 = ctx.index;
    var ctx_r828 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r829)("index", i_r830)("template", ctx_r828.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r828.showTransformOptions)("hideTransformOptions", ctx_r828.hideTransformOptions)("showTransitionOptions", ctx_r828.showTransitionOptions)("hideTransitionOptions", ctx_r828.hideTransitionOptions);
} }
