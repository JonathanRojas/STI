...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r809); var ctx_r808 = ɵngcc0.ɵɵnextContext(); return ctx_r808.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r809); var ctx_r810 = ɵngcc0.ɵɵnextContext(); return ctx_r810.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r806.message.severity == "info", ctx_r806.message.severity == "warn", ctx_r806.message.severity == "error", ctx_r806.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r806.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r806.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r816); var ctx_r815 = ɵngcc0.ɵɵnextContext(); return ctx_r815.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r816); var ctx_r817 = ɵngcc0.ɵɵnextContext(); return ctx_r817.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var msg_r813 = ctx.$implicit;
    var i_r814 = ctx.index;
    var ctx_r812 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r813)("index", i_r814)("template", ctx_r812.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r812.showTransformOptions)("hideTransformOptions", ctx_r812.hideTransformOptions)("showTransitionOptions", ctx_r812.showTransitionOptions)("hideTransitionOptions", ctx_r812.hideTransitionOptions);
} }
