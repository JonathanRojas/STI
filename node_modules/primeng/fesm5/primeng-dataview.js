...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r484.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r491); var ctx_r490 = ɵngcc0.ɵɵnextContext(); return ctx_r490.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r485 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r485.rows)("first", ctx_r485.first)("totalRecords", ctx_r485.totalRecords)("pageLinkSize", ctx_r485.pageLinks)("alwaysShow", ctx_r485.alwaysShowPaginator)("rowsPerPageOptions", ctx_r485.rowsPerPageOptions)("dropdownAppendTo", ctx_r485.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r485.paginatorDropdownScrollHeight)("templateLeft", ctx_r485.paginatorLeftTemplate)("templateRight", ctx_r485.paginatorRightTemplate)("currentPageReportTemplate", ctx_r485.currentPageReportTemplate)("showCurrentPageReport", ctx_r485.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r492 = ctx.$implicit;
    var rowIndex_r493 = ctx.index;
    var ctx_r486 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r486.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r492, rowIndex_r493));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r487.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r496); var ctx_r495 = ɵngcc0.ɵɵnextContext(); return ctx_r495.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r488 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r488.rows)("first", ctx_r488.first)("totalRecords", ctx_r488.totalRecords)("pageLinkSize", ctx_r488.pageLinks)("alwaysShow", ctx_r488.alwaysShowPaginator)("rowsPerPageOptions", ctx_r488.rowsPerPageOptions)("dropdownAppendTo", ctx_r488.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r488.paginatorDropdownScrollHeight)("templateLeft", ctx_r488.paginatorLeftTemplate)("templateRight", ctx_r488.paginatorRightTemplate)("currentPageReportTemplate", ctx_r488.currentPageReportTemplate)("showCurrentPageReport", ctx_r488.showCurrentPageReport);
} }
