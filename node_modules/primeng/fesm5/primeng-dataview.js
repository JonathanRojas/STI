...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r552.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r559); var ctx_r558 = ɵngcc0.ɵɵnextContext(); return ctx_r558.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r553 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r553.rows)("first", ctx_r553.first)("totalRecords", ctx_r553.totalRecords)("pageLinkSize", ctx_r553.pageLinks)("alwaysShow", ctx_r553.alwaysShowPaginator)("rowsPerPageOptions", ctx_r553.rowsPerPageOptions)("dropdownAppendTo", ctx_r553.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r553.paginatorDropdownScrollHeight)("templateLeft", ctx_r553.paginatorLeftTemplate)("templateRight", ctx_r553.paginatorRightTemplate)("currentPageReportTemplate", ctx_r553.currentPageReportTemplate)("showCurrentPageReport", ctx_r553.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r560 = ctx.$implicit;
    var rowIndex_r561 = ctx.index;
    var ctx_r554 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r554.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r560, rowIndex_r561));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r555.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r564); var ctx_r563 = ɵngcc0.ɵɵnextContext(); return ctx_r563.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r556 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r556.rows)("first", ctx_r556.first)("totalRecords", ctx_r556.totalRecords)("pageLinkSize", ctx_r556.pageLinks)("alwaysShow", ctx_r556.alwaysShowPaginator)("rowsPerPageOptions", ctx_r556.rowsPerPageOptions)("dropdownAppendTo", ctx_r556.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r556.paginatorDropdownScrollHeight)("templateLeft", ctx_r556.paginatorLeftTemplate)("templateRight", ctx_r556.paginatorRightTemplate)("currentPageReportTemplate", ctx_r556.currentPageReportTemplate)("showCurrentPageReport", ctx_r556.showCurrentPageReport);
} }
