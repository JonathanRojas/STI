...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r482.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r489); var ctx_r488 = ɵngcc0.ɵɵnextContext(); return ctx_r488.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r483 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r483.rows)("first", ctx_r483.first)("totalRecords", ctx_r483.totalRecords)("pageLinkSize", ctx_r483.pageLinks)("alwaysShow", ctx_r483.alwaysShowPaginator)("rowsPerPageOptions", ctx_r483.rowsPerPageOptions)("dropdownAppendTo", ctx_r483.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r483.paginatorDropdownScrollHeight)("templateLeft", ctx_r483.paginatorLeftTemplate)("templateRight", ctx_r483.paginatorRightTemplate)("currentPageReportTemplate", ctx_r483.currentPageReportTemplate)("showCurrentPageReport", ctx_r483.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r490 = ctx.$implicit;
    var rowIndex_r491 = ctx.index;
    var ctx_r484 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r484.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r490, rowIndex_r491));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r485.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r494); var ctx_r493 = ɵngcc0.ɵɵnextContext(); return ctx_r493.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r486 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r486.rows)("first", ctx_r486.first)("totalRecords", ctx_r486.totalRecords)("pageLinkSize", ctx_r486.pageLinks)("alwaysShow", ctx_r486.alwaysShowPaginator)("rowsPerPageOptions", ctx_r486.rowsPerPageOptions)("dropdownAppendTo", ctx_r486.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r486.paginatorDropdownScrollHeight)("templateLeft", ctx_r486.paginatorLeftTemplate)("templateRight", ctx_r486.paginatorRightTemplate)("currentPageReportTemplate", ctx_r486.currentPageReportTemplate)("showCurrentPageReport", ctx_r486.showCurrentPageReport);
} }
