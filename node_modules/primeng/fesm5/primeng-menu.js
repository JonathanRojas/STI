...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r586.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r588); var ctx_r587 = ɵngcc0.ɵɵnextContext(); return ctx_r587.menu.itemClick($event, ctx_r587.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r584.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r584.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r584.item.tabindex ? ctx_r584.item.tabindex : "0")("data-automationid", ctx_r584.item.automationId)("target", ctx_r584.item.target)("title", ctx_r584.item.title)("id", ctx_r584.item.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r584.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r584.item.label);
} }
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 5);
} if (rf & 2) {
    var ctx_r589 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r589.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r591); var ctx_r590 = ɵngcc0.ɵɵnextContext(); return ctx_r590.menu.itemClick($event, ctx_r590.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r585.item.routerLink)("queryParams", ctx_r585.item.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", ctx_r585.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(12, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(13, _c1, ctx_r585.item.disabled));
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r585.item.automationId)("target", ctx_r585.item.target)("id", ctx_r585.item.id)("tabindex", ctx_r585.item.tabindex ? ctx_r585.item.tabindex : "0")("title", ctx_r585.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r585.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r585.item.label);
} }
var _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r597 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r597.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r597 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r597.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r597.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r597.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r603 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r597 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r603.visible === false || submenu_r597.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r603 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r597 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r603.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r603)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r603.visible === false || submenu_r597.visible === false))("ngStyle", item_r603.style);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", item_r603.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r603.separator);
} }
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r597 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r597.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r597.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r597.items);
} }
function Menu_div_0_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtemplate(0, Menu_div_0_3_ng_template_0_Template, 3, 3, "ng-template", 4);
} if (rf & 2) {
    var ctx_r594 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r594.model);
} }
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r611 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r611.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 10);
} if (rf & 2) {
    var item_r611 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r611.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r611)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r611.visible === false))("ngStyle", item_r611.style);
} }
function Menu_div_0_4_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r611 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r611.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r611.separator);
} }
function Menu_div_0_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r595.model);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r617); var ctx_r616 = ɵngcc0.ɵɵnextContext(); return ctx_r616.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r617); var ctx_r618 = ɵngcc0.ɵɵnextContext(); return ctx_r618.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵclassMap(ctx_r592.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r592.popup))("ngStyle", ctx_r592.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r592.showTransitionOptions, ctx_r592.hideTransitionOptions)))("@.disabled", ctx_r592.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r592.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r592.hasSubMenu());
} }
