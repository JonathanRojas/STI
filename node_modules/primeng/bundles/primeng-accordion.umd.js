(function (global, factory) {
    ...
    (global = global || self, factory(global.ng.core,global.ng.common,global.primeng.api,(global.primeng = global.primeng || {}, global.primeng.accordion = {}), global.ng.core, global.ng.animations, global.ng.common, global.primeng.api));
...
function AccordionTab_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r204.header, " ");
} }
...
function AccordionTab_ng_container_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r206.contentTemplate);
} }
var _c0 = ["*", [["p-header"]]];
...
'use strict';
    ...
    var AccordionTab = /** @class */ (function () {
        ...
        AccordionTab = __decorate([ __param(0, core.Inject(core.forwardRef(function () { return Accordion; })))
        ], AccordionTab);
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AccordionModule, { declarations: [Accordion,
        AccordionTab], imports: [ɵngcc1.CommonModule], exports: [Accordion,
        AccordionTab, ɵngcc2.SharedModule] }); })();
