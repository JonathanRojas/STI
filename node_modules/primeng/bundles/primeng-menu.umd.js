...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var ctx_r581 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r581.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r583); var ctx_r582 = ɵngcc0.ɵɵnextContext(); return ctx_r582.menu.itemClick($event, ctx_r582.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r579.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r579.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r579.item.tabindex ? ctx_r579.item.tabindex : "0")("data-automationid", ctx_r579.item.automationId)("target", ctx_r579.item.target)("title", ctx_r579.item.title)("id", ctx_r579.item.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r579.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r579.item.label);
} }
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 5);
} if (rf & 2) {
    var ctx_r584 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r584.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r586); var ctx_r585 = ɵngcc0.ɵɵnextContext(); return ctx_r585.menu.itemClick($event, ctx_r585.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r580.item.routerLink)("queryParams", ctx_r580.item.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", ctx_r580.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(12, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(13, _c1, ctx_r580.item.disabled));
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r580.item.automationId)("target", ctx_r580.item.target)("id", ctx_r580.item.id)("tabindex", ctx_r580.item.tabindex ? ctx_r580.item.tabindex : "0")("title", ctx_r580.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r580.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r580.item.label);
} }
var _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r592 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r592.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r592 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r592.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r592.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r592.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r598 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r592 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r598.visible === false || submenu_r592.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r598 = ɵngcc0.ɵɵnextContext().$implicit;
    var submenu_r592 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r598.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r598)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r598.visible === false || submenu_r592.visible === false))("ngStyle", item_r598.style);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r598 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r598.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r598.separator);
} }
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r592 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r592.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r592.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r592.items);
} }
function Menu_div_0_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r589.model);
} }
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    var item_r606 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r606.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r606)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r606.visible === false))("ngStyle", item_r606.style);
} }
function Menu_div_0_4_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r606 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r606.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r606.separator);
} }
function Menu_div_0_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r590.model);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r612); var ctx_r611 = ɵngcc0.ɵɵnextContext(); return ctx_r611.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r612); var ctx_r613 = ɵngcc0.ɵɵnextContext(); return ctx_r613.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵclassMap(ctx_r587.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r587.popup))("ngStyle", ctx_r587.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r587.showTransitionOptions, ctx_r587.hideTransitionOptions)))("@.disabled", ctx_r587.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r587.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r587.hasSubMenu());
} }
'use strict';
