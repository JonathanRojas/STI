...
function DynamicDialogComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function DynamicDialogComponent_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r466); const ctx_r465 = ɵngcc0.ɵɵnextContext(); return ctx_r465.onMaskClick(); });
    ɵngcc0.ɵɵelementEnd();
} }
function DynamicDialogComponent_div_1_div_1_a_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function DynamicDialogComponent_div_1_div_1_a_4_Template_a_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r472); const ctx_r471 = ɵngcc0.ɵɵnextContext(3); return ctx_r471.close(); })("keydown.enter", function DynamicDialogComponent_div_1_div_1_a_4_Template_a_keydown_enter_0_listener() { ɵngcc0.ɵɵrestoreView(_r472); const ctx_r473 = ɵngcc0.ɵɵnextContext(3); return ctx_r473.close(); });
...
function DynamicDialogComponent_div_1_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r467.config.header);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r467.config.closable !== false);
} }
...
function DynamicDialogComponent_div_1_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r469 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r469.config.footer, " ");
} }
...
function DynamicDialogComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("@animation.start", function DynamicDialogComponent_div_1_Template_div_animation_animation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r475); const ctx_r474 = ɵngcc0.ɵɵnextContext(); return ctx_r474.onAnimationStart($event); })("@animation.done", function DynamicDialogComponent_div_1_Template_div_animation_animation_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r475); const ctx_r476 = ɵngcc0.ɵɵnextContext(); return ctx_r476.onAnimationEnd($event); });
    ...
    ɵngcc0.ɵɵclassMap(ctx_r463.config.styleClass);
    ɵngcc0.ɵɵstyleProp("width", ctx_r463.config.width)("height", ctx_r463.config.height);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c1, ctx_r463.config.rtl))("ngStyle", ctx_r463.config.style)("@animation", ɵngcc0.ɵɵpureFunction1(16, _c3, ɵngcc0.ɵɵpureFunction1(14, _c2, ctx_r463.config.transitionOptions || "150ms cubic-bezier(0, 0, 0.2, 1)")));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r463.config.showHeader === false ? false : true);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", ctx_r463.config.contentStyle);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r463.config.footer);
} }
