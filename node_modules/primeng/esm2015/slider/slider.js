...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r599.handleValues[0] + "%", ctx_r599.handleValues[1] - ctx_r599.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r600.handleValues[0] + "%", ctx_r600.handleValues[1] - ctx_r600.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r601.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r602.handleValue + "%"));
} }
const _c7 = function (a0, a1) { return { "left": a0, "bottom": a1 }; };
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    const _r608 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 7, 8);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r608); const ctx_r607 = ɵngcc0.ɵɵnextContext(); return ctx_r607.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r608); const ctx_r609 = ɵngcc0.ɵɵnextContext(); return ctx_r609.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r608); const ctx_r610 = ɵngcc0.ɵɵnextContext(); return ctx_r610.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r608); const ctx_r611 = ɵngcc0.ɵɵnextContext(); return ctx_r611.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r608); const ctx_r612 = ɵngcc0.ɵɵnextContext(); return ctx_r612.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r603 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r603.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r603.orientation == "horizontal" ? ctx_r603.handleValue + "%" : null, ctx_r603.orientation == "vertical" ? ctx_r603.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r603.tabindex)("aria-valuemin", ctx_r603.min)("aria-valuenow", ctx_r603.value)("aria-valuemax", ctx_r603.max)("aria-labelledby", ctx_r603.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r615); const ctx_r614 = ɵngcc0.ɵɵnextContext(); return ctx_r614.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r615); const ctx_r616 = ɵngcc0.ɵɵnextContext(); return ctx_r616.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r615); const ctx_r617 = ɵngcc0.ɵɵnextContext(); return ctx_r617.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r615); const ctx_r618 = ɵngcc0.ɵɵnextContext(); return ctx_r618.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r615); const ctx_r619 = ɵngcc0.ɵɵnextContext(); return ctx_r619.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r604 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r604.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r604.rangeStartLeft, ctx_r604.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r604.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r604.tabindex)("aria-valuemin", ctx_r604.min)("aria-valuenow", ctx_r604.value ? ctx_r604.value[0] : null)("aria-valuemax", ctx_r604.max)("aria-labelledby", ctx_r604.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r622 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r622); const ctx_r621 = ɵngcc0.ɵɵnextContext(); return ctx_r621.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r622); const ctx_r623 = ɵngcc0.ɵɵnextContext(); return ctx_r623.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r622); const ctx_r624 = ɵngcc0.ɵɵnextContext(); return ctx_r624.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r622); const ctx_r625 = ɵngcc0.ɵɵnextContext(); return ctx_r625.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r622); const ctx_r626 = ɵngcc0.ɵɵnextContext(); return ctx_r626.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r605 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r605.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r605.rangeEndLeft, ctx_r605.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r605.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r605.tabindex)("aria-valuemin", ctx_r605.min)("aria-valuenow", ctx_r605.value ? ctx_r605.value[1] : null)("aria-valuemax", ctx_r605.max)("aria-labelledby", ctx_r605.ariaLabelledBy);
} }
