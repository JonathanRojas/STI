...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r686.handleValues[0] + "%", ctx_r686.handleValues[1] - ctx_r686.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r687.handleValues[0] + "%", ctx_r687.handleValues[1] - ctx_r687.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r688.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r689.handleValue + "%"));
} }
const _c7 = function (a0, a1) { return { "left": a0, "bottom": a1 }; };
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    const _r695 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 7, 8);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r695); const ctx_r694 = ɵngcc0.ɵɵnextContext(); return ctx_r694.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r695); const ctx_r696 = ɵngcc0.ɵɵnextContext(); return ctx_r696.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r695); const ctx_r697 = ɵngcc0.ɵɵnextContext(); return ctx_r697.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r695); const ctx_r698 = ɵngcc0.ɵɵnextContext(); return ctx_r698.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r695); const ctx_r699 = ɵngcc0.ɵɵnextContext(); return ctx_r699.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r690 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r690.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r690.orientation == "horizontal" ? ctx_r690.handleValue + "%" : null, ctx_r690.orientation == "vertical" ? ctx_r690.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r690.tabindex)("aria-valuemin", ctx_r690.min)("aria-valuenow", ctx_r690.value)("aria-valuemax", ctx_r690.max)("aria-labelledby", ctx_r690.ariaLabelledBy);
} }
const _c8 = function (a0) { return { "ui-slider-handle-active": a0 }; };
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    const _r702 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 10);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r702); const ctx_r701 = ɵngcc0.ɵɵnextContext(); return ctx_r701.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r702); const ctx_r703 = ɵngcc0.ɵɵnextContext(); return ctx_r703.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r702); const ctx_r704 = ɵngcc0.ɵɵnextContext(); return ctx_r704.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r702); const ctx_r705 = ɵngcc0.ɵɵnextContext(); return ctx_r705.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r702); const ctx_r706 = ɵngcc0.ɵɵnextContext(); return ctx_r706.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r691 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r691.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r691.rangeStartLeft, ctx_r691.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r691.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r691.tabindex)("aria-valuemin", ctx_r691.min)("aria-valuenow", ctx_r691.value ? ctx_r691.value[0] : null)("aria-valuemax", ctx_r691.max)("aria-labelledby", ctx_r691.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r709 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r708 = ɵngcc0.ɵɵnextContext(); return ctx_r708.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r710 = ɵngcc0.ɵɵnextContext(); return ctx_r710.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r711 = ɵngcc0.ɵɵnextContext(); return ctx_r711.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r712 = ɵngcc0.ɵɵnextContext(); return ctx_r712.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r713 = ɵngcc0.ɵɵnextContext(); return ctx_r713.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r692 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r692.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r692.rangeEndLeft, ctx_r692.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r692.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r692.tabindex)("aria-valuemin", ctx_r692.min)("aria-valuenow", ctx_r692.value ? ctx_r692.value[1] : null)("aria-valuemax", ctx_r692.max)("aria-labelledby", ctx_r692.ariaLabelledBy);
} }
