...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r478.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r485); const ctx_r484 = ɵngcc0.ɵɵnextContext(); return ctx_r484.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r479 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r479.rows)("first", ctx_r479.first)("totalRecords", ctx_r479.totalRecords)("pageLinkSize", ctx_r479.pageLinks)("alwaysShow", ctx_r479.alwaysShowPaginator)("rowsPerPageOptions", ctx_r479.rowsPerPageOptions)("dropdownAppendTo", ctx_r479.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r479.paginatorDropdownScrollHeight)("templateLeft", ctx_r479.paginatorLeftTemplate)("templateRight", ctx_r479.paginatorRightTemplate)("currentPageReportTemplate", ctx_r479.currentPageReportTemplate)("showCurrentPageReport", ctx_r479.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowData_r486 = ctx.$implicit;
    const rowIndex_r487 = ctx.index;
    const ctx_r480 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r480.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r486, rowIndex_r487));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r481.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r490); const ctx_r489 = ɵngcc0.ɵɵnextContext(); return ctx_r489.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r482 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r482.rows)("first", ctx_r482.first)("totalRecords", ctx_r482.totalRecords)("pageLinkSize", ctx_r482.pageLinks)("alwaysShow", ctx_r482.alwaysShowPaginator)("rowsPerPageOptions", ctx_r482.rowsPerPageOptions)("dropdownAppendTo", ctx_r482.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r482.paginatorDropdownScrollHeight)("templateLeft", ctx_r482.paginatorLeftTemplate)("templateRight", ctx_r482.paginatorRightTemplate)("currentPageReportTemplate", ctx_r482.currentPageReportTemplate)("showCurrentPageReport", ctx_r482.showCurrentPageReport);
} }
