...
function TreeTable_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-treetable-loading-icon pi-spin " + ctx_r339.loadingIcon);
} }
...
function TreeTable_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r340.captionTemplate);
} }
function TreeTable_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function TreeTable_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r351); const ctx_r350 = ɵngcc0.ɵɵnextContext(); return ctx_r350.onPageChange($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r341 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r341.rows)("first", ctx_r341.first)("totalRecords", ctx_r341.totalRecords)("pageLinkSize", ctx_r341.pageLinks)("alwaysShow", ctx_r341.alwaysShowPaginator)("rowsPerPageOptions", ctx_r341.rowsPerPageOptions)("templateLeft", ctx_r341.paginatorLeftTemplate)("templateRight", ctx_r341.paginatorRightTemplate)("dropdownAppendTo", ctx_r341.paginatorDropdownAppendTo)("currentPageReportTemplate", ctx_r341.currentPageReportTemplate)("showCurrentPageReport", ctx_r341.showCurrentPageReport);
} }
...
function TreeTable_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r342.colGroupTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r342.columns));
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r342.headerTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction1(10, _c5, ctx_r342.columns));
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r342.footerTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction1(12, _c5, ctx_r342.columns));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("pTreeTableBody", ctx_r342.columns)("pTreeTableBodyTemplate", ctx_r342.bodyTemplate);
} }
...
function TreeTable_div_7_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ttScrollableView", ctx_r356.frozenColumns)("frozen", true)("ngStyle", ɵngcc0.ɵɵpureFunction1(4, _c6, ctx_r356.frozenWidth))("scrollHeight", ctx_r356.scrollHeight);
} }
function TreeTable_div_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r343.frozenColumns || ctx_r343.frozenBodyTemplate);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ttScrollableView", ctx_r343.columns)("frozen", false)("scrollHeight", ctx_r343.scrollHeight);
} }
function TreeTable_p_paginator_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function TreeTable_p_paginator_8_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r358); const ctx_r357 = ɵngcc0.ɵɵnextContext(); return ctx_r357.onPageChange($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r344 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r344.rows)("first", ctx_r344.first)("totalRecords", ctx_r344.totalRecords)("pageLinkSize", ctx_r344.pageLinks)("alwaysShow", ctx_r344.alwaysShowPaginator)("rowsPerPageOptions", ctx_r344.rowsPerPageOptions)("templateLeft", ctx_r344.paginatorLeftTemplate)("templateRight", ctx_r344.paginatorRightTemplate)("dropdownAppendTo", ctx_r344.paginatorDropdownAppendTo)("currentPageReportTemplate", ctx_r344.currentPageReportTemplate)("showCurrentPageReport", ctx_r344.showCurrentPageReport);
} }
...
function TreeTable_div_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r345.summaryTemplate);
} }
...
function TTBody_ng_template_0_ng_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const serializedNode_r365 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r367 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r367.template)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction4(2, _c9, serializedNode_r365, serializedNode_r365.node, serializedNode_r365.node.data, ctx_r367.columns));
} }
function TTBody_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const serializedNode_r365 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", serializedNode_r365.visible);
} }
...
function TTBody_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r364.tt.emptyMessageTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction1(2, _c5, ctx_r364.columns));
} }
...
function TTScrollableView_table_14_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r382.tt.loadingBodyTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction1(2, _c19, ctx_r382.columns));
} }
...
function TTScrollableView_table_14_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(2, _c20, ctx_r378.tt.virtualScroll));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r378.loadingArray);
} }
...
function TTScrollableView_div_16_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(5);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r380.frozen ? ctx_r380.tt.frozenColGroupTemplate || ctx_r380.tt.colGroupTemplate : ctx_r380.tt.colGroupTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction1(4, _c5, ctx_r380.columns));
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r380.frozen ? ctx_r380.tt.frozenFooterTemplate || ctx_r380.tt.footerTemplate : ctx_r380.tt.footerTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction1(6, _c5, ctx_r380.columns));
} }
...
function TreeTableCellEditor_ng_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r393.inputTemplate);
} }
...
function TreeTableCellEditor_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r394.outputTemplate);
} }
function TreeTableToggler_a_0_Template(rf, ctx) { if (rf & 1) {
    const _r399 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "a", 1);
    ɵngcc0.ɵɵlistener("click", function TreeTableToggler_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r399); const ctx_r398 = ɵngcc0.ɵɵnextContext(); return ctx_r398.onClick($event); });
    ɵngcc0.ɵɵelement(1, "i", 2);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r397 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("visibility", ctx_r397.rowNode.node.leaf === false || ctx_r397.rowNode.node.children && ctx_r397.rowNode.node.children.length ? "visible" : "hidden")("margin-left", ctx_r397.rowNode.level * 16 + "px");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r397.rowNode.node.expanded ? "pi pi-fw pi-chevron-down" : "pi pi-fw pi-chevron-right");
} }
...
TTHeaderCheckbox.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TTHeaderCheckbox, selectors: [["p-treeTableHeaderCheckbox"]], viewQuery: function TTHeaderCheckbox_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵelementStart(0, "div", 0);
        ɵngcc0.ɵɵlistener("click", function TTHeaderCheckbox_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r392); const _r390 = ɵngcc0.ɵɵreference(3); return ctx.onClick($event, _r390.checked); });
        ɵngcc0.ɵɵelementStart(1, "div", 1);
