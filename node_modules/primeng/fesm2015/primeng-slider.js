...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r181.handleValues[0] + "%", ctx_r181.handleValues[1] - ctx_r181.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r182.handleValues[0] + "%", ctx_r182.handleValues[1] - ctx_r182.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r183.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r184.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r190); const ctx_r189 = ɵngcc0.ɵɵnextContext(); return ctx_r189.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r190); const ctx_r191 = ɵngcc0.ɵɵnextContext(); return ctx_r191.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r190); const ctx_r192 = ɵngcc0.ɵɵnextContext(); return ctx_r192.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r190); const ctx_r193 = ɵngcc0.ɵɵnextContext(); return ctx_r193.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r190); const ctx_r194 = ɵngcc0.ɵɵnextContext(); return ctx_r194.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r185 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r185.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r185.orientation == "horizontal" ? ctx_r185.handleValue + "%" : null, ctx_r185.orientation == "vertical" ? ctx_r185.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r185.tabindex)("aria-valuemin", ctx_r185.min)("aria-valuenow", ctx_r185.value)("aria-valuemax", ctx_r185.max)("aria-labelledby", ctx_r185.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r197); const ctx_r196 = ɵngcc0.ɵɵnextContext(); return ctx_r196.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r197); const ctx_r198 = ɵngcc0.ɵɵnextContext(); return ctx_r198.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r197); const ctx_r199 = ɵngcc0.ɵɵnextContext(); return ctx_r199.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r197); const ctx_r200 = ɵngcc0.ɵɵnextContext(); return ctx_r200.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r197); const ctx_r201 = ɵngcc0.ɵɵnextContext(); return ctx_r201.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r186 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r186.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r186.rangeStartLeft, ctx_r186.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r186.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r186.tabindex)("aria-valuemin", ctx_r186.min)("aria-valuenow", ctx_r186.value ? ctx_r186.value[0] : null)("aria-valuemax", ctx_r186.max)("aria-labelledby", ctx_r186.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r204 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r204); const ctx_r203 = ɵngcc0.ɵɵnextContext(); return ctx_r203.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r204); const ctx_r205 = ɵngcc0.ɵɵnextContext(); return ctx_r205.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r204); const ctx_r206 = ɵngcc0.ɵɵnextContext(); return ctx_r206.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r204); const ctx_r207 = ɵngcc0.ɵɵnextContext(); return ctx_r207.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r204); const ctx_r208 = ɵngcc0.ɵɵnextContext(); return ctx_r208.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r187 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r187.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r187.rangeEndLeft, ctx_r187.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r187.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r187.tabindex)("aria-valuemin", ctx_r187.min)("aria-valuenow", ctx_r187.value ? ctx_r187.value[1] : null)("aria-valuemax", ctx_r187.max)("aria-labelledby", ctx_r187.ariaLabelledBy);
} }
