...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r304.handleValues[0] + "%", ctx_r304.handleValues[1] - ctx_r304.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r305.handleValues[0] + "%", ctx_r305.handleValues[1] - ctx_r305.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r306.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r307.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r313); const ctx_r312 = ɵngcc0.ɵɵnextContext(); return ctx_r312.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r313); const ctx_r314 = ɵngcc0.ɵɵnextContext(); return ctx_r314.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r313); const ctx_r315 = ɵngcc0.ɵɵnextContext(); return ctx_r315.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r313); const ctx_r316 = ɵngcc0.ɵɵnextContext(); return ctx_r316.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r313); const ctx_r317 = ɵngcc0.ɵɵnextContext(); return ctx_r317.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r308 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r308.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r308.orientation == "horizontal" ? ctx_r308.handleValue + "%" : null, ctx_r308.orientation == "vertical" ? ctx_r308.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r308.tabindex)("aria-valuemin", ctx_r308.min)("aria-valuenow", ctx_r308.value)("aria-valuemax", ctx_r308.max)("aria-labelledby", ctx_r308.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r320); const ctx_r319 = ɵngcc0.ɵɵnextContext(); return ctx_r319.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r320); const ctx_r321 = ɵngcc0.ɵɵnextContext(); return ctx_r321.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r320); const ctx_r322 = ɵngcc0.ɵɵnextContext(); return ctx_r322.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r320); const ctx_r323 = ɵngcc0.ɵɵnextContext(); return ctx_r323.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r320); const ctx_r324 = ɵngcc0.ɵɵnextContext(); return ctx_r324.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r309 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r309.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r309.rangeStartLeft, ctx_r309.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r309.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r309.tabindex)("aria-valuemin", ctx_r309.min)("aria-valuenow", ctx_r309.value ? ctx_r309.value[0] : null)("aria-valuemax", ctx_r309.max)("aria-labelledby", ctx_r309.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r327 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r327); const ctx_r326 = ɵngcc0.ɵɵnextContext(); return ctx_r326.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r327); const ctx_r328 = ɵngcc0.ɵɵnextContext(); return ctx_r328.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r327); const ctx_r329 = ɵngcc0.ɵɵnextContext(); return ctx_r329.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r327); const ctx_r330 = ɵngcc0.ɵɵnextContext(); return ctx_r330.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r327); const ctx_r331 = ɵngcc0.ɵɵnextContext(); return ctx_r331.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r310 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r310.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r310.rangeEndLeft, ctx_r310.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r310.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r310.tabindex)("aria-valuemin", ctx_r310.min)("aria-valuenow", ctx_r310.value ? ctx_r310.value[1] : null)("aria-valuemax", ctx_r310.max)("aria-labelledby", ctx_r310.ariaLabelledBy);
} }
