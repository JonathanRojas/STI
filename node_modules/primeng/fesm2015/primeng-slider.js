...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r223.handleValues[0] + "%", ctx_r223.handleValues[1] - ctx_r223.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r224.handleValues[0] + "%", ctx_r224.handleValues[1] - ctx_r224.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r225.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r226.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r232); const ctx_r231 = ɵngcc0.ɵɵnextContext(); return ctx_r231.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r232); const ctx_r233 = ɵngcc0.ɵɵnextContext(); return ctx_r233.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r232); const ctx_r234 = ɵngcc0.ɵɵnextContext(); return ctx_r234.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r232); const ctx_r235 = ɵngcc0.ɵɵnextContext(); return ctx_r235.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r232); const ctx_r236 = ɵngcc0.ɵɵnextContext(); return ctx_r236.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r227 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r227.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r227.orientation == "horizontal" ? ctx_r227.handleValue + "%" : null, ctx_r227.orientation == "vertical" ? ctx_r227.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r227.tabindex)("aria-valuemin", ctx_r227.min)("aria-valuenow", ctx_r227.value)("aria-valuemax", ctx_r227.max)("aria-labelledby", ctx_r227.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r239); const ctx_r238 = ɵngcc0.ɵɵnextContext(); return ctx_r238.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r239); const ctx_r240 = ɵngcc0.ɵɵnextContext(); return ctx_r240.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r239); const ctx_r241 = ɵngcc0.ɵɵnextContext(); return ctx_r241.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r239); const ctx_r242 = ɵngcc0.ɵɵnextContext(); return ctx_r242.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r239); const ctx_r243 = ɵngcc0.ɵɵnextContext(); return ctx_r243.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r228 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r228.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r228.rangeStartLeft, ctx_r228.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r228.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r228.tabindex)("aria-valuemin", ctx_r228.min)("aria-valuenow", ctx_r228.value ? ctx_r228.value[0] : null)("aria-valuemax", ctx_r228.max)("aria-labelledby", ctx_r228.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r246 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r246); const ctx_r245 = ɵngcc0.ɵɵnextContext(); return ctx_r245.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r246); const ctx_r247 = ɵngcc0.ɵɵnextContext(); return ctx_r247.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r246); const ctx_r248 = ɵngcc0.ɵɵnextContext(); return ctx_r248.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r246); const ctx_r249 = ɵngcc0.ɵɵnextContext(); return ctx_r249.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r246); const ctx_r250 = ɵngcc0.ɵɵnextContext(); return ctx_r250.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r229 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r229.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r229.rangeEndLeft, ctx_r229.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r229.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r229.tabindex)("aria-valuemin", ctx_r229.min)("aria-valuenow", ctx_r229.value ? ctx_r229.value[1] : null)("aria-valuemax", ctx_r229.max)("aria-labelledby", ctx_r229.ariaLabelledBy);
} }
