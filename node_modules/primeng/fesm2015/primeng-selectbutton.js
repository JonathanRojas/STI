...
function SelectButton_div_1_ng_container_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r68 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵclassMap(option_r68.icon);
...
function SelectButton_div_1_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", option_r68.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(option_r68.label || "ui-btn");
} }
...
function SelectButton_div_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r68 = ctx_r78.$implicit;
    const i_r69 = ctx_r78.index;
    const ctx_r73 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r73.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c1, option_r68, i_r69));
} }
...
function SelectButton_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SelectButton_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r80); const option_r68 = ctx.$implicit; const i_r69 = ctx.index; const ctx_r79 = ɵngcc0.ɵɵnextContext(); return ctx_r79.onItemClick($event, option_r68, i_r69); })("keydown.enter", function SelectButton_div_1_Template_div_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r80); const option_r68 = ctx.$implicit; const i_r69 = ctx.index; const ctx_r81 = ɵngcc0.ɵɵnextContext(); return ctx_r81.onItemClick($event, option_r68, i_r69); })("focus", function SelectButton_div_1_Template_div_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r80); const ctx_r82 = ɵngcc0.ɵɵnextContext(); return ctx_r82.onFocus($event); })("blur", function SelectButton_div_1_Template_div_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r80); const ctx_r83 = ɵngcc0.ɵɵnextContext(); return ctx_r83.onBlur($event); });
    ...
    const _r72 = ɵngcc0.ɵɵreference(4);
    const ctx_r67 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("ui-button ui-widget ui-state-default ui-button-text-only ", option_r68.styleClass, "");
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction5(11, _c2, ctx_r67.isSelected(option_r68), ctx_r67.disabled || option_r68.disabled, _r70 == ctx_r67.focusedItem, option_r68.icon != null, option_r68.icon && !option_r68.label));
    ɵngcc0.ɵɵattribute("aria-pressed", ctx_r67.isSelected(option_r68))("title", option_r68.title)("aria-label", option_r68.label)("tabindex", ctx_r67.tabindex)("aria-labelledby", ctx_r67.ariaLabelledBy);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r67.itemTemplate)("ngIfElse", _r72);
} }
