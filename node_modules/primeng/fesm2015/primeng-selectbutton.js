...
function SelectButton_div_1_ng_container_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r80 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵclassMap(option_r80.icon);
...
function SelectButton_div_1_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r80 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", option_r80.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(option_r80.label || "ui-btn");
} }
...
function SelectButton_div_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r80 = ctx_r90.$implicit;
    const i_r81 = ctx_r90.index;
    const ctx_r85 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r85.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c1, option_r80, i_r81));
} }
...
function SelectButton_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SelectButton_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r92); const option_r80 = ctx.$implicit; const i_r81 = ctx.index; const ctx_r91 = ɵngcc0.ɵɵnextContext(); return ctx_r91.onItemClick($event, option_r80, i_r81); })("keydown.enter", function SelectButton_div_1_Template_div_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r92); const option_r80 = ctx.$implicit; const i_r81 = ctx.index; const ctx_r93 = ɵngcc0.ɵɵnextContext(); return ctx_r93.onItemClick($event, option_r80, i_r81); })("focus", function SelectButton_div_1_Template_div_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r92); const ctx_r94 = ɵngcc0.ɵɵnextContext(); return ctx_r94.onFocus($event); })("blur", function SelectButton_div_1_Template_div_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r92); const ctx_r95 = ɵngcc0.ɵɵnextContext(); return ctx_r95.onBlur($event); });
    ...
    const _r84 = ɵngcc0.ɵɵreference(4);
    const ctx_r79 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("ui-button ui-widget ui-state-default ui-button-text-only ", option_r80.styleClass, "");
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction5(11, _c2, ctx_r79.isSelected(option_r80), ctx_r79.disabled || option_r80.disabled, _r82 == ctx_r79.focusedItem, option_r80.icon != null, option_r80.icon && !option_r80.label));
    ɵngcc0.ɵɵattribute("aria-pressed", ctx_r79.isSelected(option_r80))("title", option_r80.title)("aria-label", option_r80.label)("tabindex", ctx_r79.tabindex)("aria-labelledby", ctx_r79.ariaLabelledBy);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r79.itemTemplate)("ngIfElse", _r84);
} }
