...
function Steps_li_2_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r126); const ctx_r127 = ɵngcc0.ɵɵnextContext(); const item_r120 = ctx_r127.$implicit; const i_r121 = ctx_r127.index; const ctx_r125 = ɵngcc0.ɵɵnextContext(); return ctx_r125.itemClick($event, item_r120, i_r121); })("keydown.enter", function Steps_li_2_a_2_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r126); const ctx_r129 = ɵngcc0.ɵɵnextContext(); const item_r120 = ctx_r129.$implicit; const i_r121 = ctx_r129.index; const ctx_r128 = ɵngcc0.ɵɵnextContext(); return ctx_r128.itemClick($event, item_r120, i_r121); });
    ...
    const item_r120 = ctx_r130.$implicit;
    const i_r121 = ctx_r130.index;
    const ctx_r123 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵattribute("href", item_r120.url, ɵngcc0.ɵɵsanitizeUrl)("target", item_r120.target)("id", item_r120.id)("tabindex", item_r120.disabled || i_r121 !== ctx_r123.activeIndex && ctx_r123.readonly ? null : item_r120.tabindex ? item_r120.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r121 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r120.label);
} }
...
function Steps_li_2_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const ctx_r133 = ɵngcc0.ɵɵnextContext(); const item_r120 = ctx_r133.$implicit; const i_r121 = ctx_r133.index; const ctx_r131 = ɵngcc0.ɵɵnextContext(); return ctx_r131.itemClick($event, item_r120, i_r121); })("keydown.enter", function Steps_li_2_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const ctx_r135 = ɵngcc0.ɵɵnextContext(); const item_r120 = ctx_r135.$implicit; const i_r121 = ctx_r135.index; const ctx_r134 = ɵngcc0.ɵɵnextContext(); return ctx_r134.itemClick($event, item_r120, i_r121); });
    ɵngcc0.ɵɵelementStart(1, "span", 8);
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(3, "span", 9);
    ...
    const item_r120 = ctx_r136.$implicit;
    const i_r121 = ctx_r136.index;
    const ctx_r124 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", item_r120.routerLink)("queryParams", item_r120.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", item_r120.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(9, _c0));
    ɵngcc0.ɵɵattribute("target", item_r120.target)("id", item_r120.id)("tabindex", item_r120.disabled || i_r121 !== ctx_r124.activeIndex && ctx_r124.readonly ? null : item_r120.tabindex ? item_r120.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r121 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r120.label);
...
function Steps_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", item_r120.style)("ngClass", ɵngcc0.ɵɵpureFunction4(8, _c1, i_r121 === ctx_r119.activeIndex, i_r121 !== ctx_r119.activeIndex, i_r121 < ctx_r119.activeIndex, item_r120.disabled || i_r121 !== ctx_r119.activeIndex && ctx_r119.readonly));
    ɵngcc0.ɵɵattribute("aria-selected", i_r121 === ctx_r119.activeIndex)("aria-expanded", i_r121 === ctx_r119.activeIndex);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !item_r120.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r120.routerLink);
} }
