...
function Steps_li_2_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r167); const ctx_r168 = ɵngcc0.ɵɵnextContext(); const item_r161 = ctx_r168.$implicit; const i_r162 = ctx_r168.index; const ctx_r166 = ɵngcc0.ɵɵnextContext(); return ctx_r166.itemClick($event, item_r161, i_r162); })("keydown.enter", function Steps_li_2_a_2_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r167); const ctx_r170 = ɵngcc0.ɵɵnextContext(); const item_r161 = ctx_r170.$implicit; const i_r162 = ctx_r170.index; const ctx_r169 = ɵngcc0.ɵɵnextContext(); return ctx_r169.itemClick($event, item_r161, i_r162); });
    ...
    const item_r161 = ctx_r171.$implicit;
    const i_r162 = ctx_r171.index;
    const ctx_r164 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵattribute("href", item_r161.url, ɵngcc0.ɵɵsanitizeUrl)("target", item_r161.target)("id", item_r161.id)("tabindex", item_r161.disabled || i_r162 !== ctx_r164.activeIndex && ctx_r164.readonly ? null : item_r161.tabindex ? item_r161.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r162 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r161.label);
} }
...
function Steps_li_2_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r173); const ctx_r174 = ɵngcc0.ɵɵnextContext(); const item_r161 = ctx_r174.$implicit; const i_r162 = ctx_r174.index; const ctx_r172 = ɵngcc0.ɵɵnextContext(); return ctx_r172.itemClick($event, item_r161, i_r162); })("keydown.enter", function Steps_li_2_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r173); const ctx_r176 = ɵngcc0.ɵɵnextContext(); const item_r161 = ctx_r176.$implicit; const i_r162 = ctx_r176.index; const ctx_r175 = ɵngcc0.ɵɵnextContext(); return ctx_r175.itemClick($event, item_r161, i_r162); });
    ɵngcc0.ɵɵelementStart(1, "span", 8);
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(3, "span", 9);
    ...
    const item_r161 = ctx_r177.$implicit;
    const i_r162 = ctx_r177.index;
    const ctx_r165 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", item_r161.routerLink)("queryParams", item_r161.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", item_r161.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(9, _c0));
    ɵngcc0.ɵɵattribute("target", item_r161.target)("id", item_r161.id)("tabindex", item_r161.disabled || i_r162 !== ctx_r165.activeIndex && ctx_r165.readonly ? null : item_r161.tabindex ? item_r161.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r162 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r161.label);
...
function Steps_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMap(item_r161.styleClass);
    ɵngcc0.ɵɵproperty("ngStyle", item_r161.style)("ngClass", ɵngcc0.ɵɵpureFunction4(8, _c1, i_r162 === ctx_r160.activeIndex, i_r162 !== ctx_r160.activeIndex, i_r162 < ctx_r160.activeIndex, item_r161.disabled || i_r162 !== ctx_r160.activeIndex && ctx_r160.readonly));
    ɵngcc0.ɵɵattribute("aria-selected", i_r162 === ctx_r160.activeIndex)("aria-expanded", i_r162 === ctx_r160.activeIndex);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !item_r161.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r161.routerLink);
} }
